...
<head>
    <meta charset="UTF-8">
    <title>Table Kelayakan MBKM - Dosen Wali</title>
    ...
    <!-- Bootstrap CSS (Included Once) -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    
    <!-- Font Awesome (Included Once) -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(90deg, #0073e6, #003366);">
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ route('home.doswal') }}">
          <img
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link
                @if(in_array(Route::currentRouteName(), ['home', 'home.doswal']))
                  active
                @endif
              " href="{{ route('home.doswal') }}">
                Beranda
              </a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMBKM">
                <li><a class="dropdown-item" href="{{ route('doswal.tabelinput_mbkm') }}">Table Eligible MBKM</a></li>
                <li><a class="dropdown-item" href="{{ route('doswal.tabel_mbkm') }}">Table Pertimbangan MBKM</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownKP">
                <li>
                  <a class="dropdown-item" href="{{ route('doswal.tabelinputkp') }}">
