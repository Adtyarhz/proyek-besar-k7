{{-- resources/views/app/kaprodi/tabel_mbkm.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    @forelse($pendaftaranMbkm as $index => $pendaftaran)
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <button type="button" class="btn btn-sm btn-link" data-bs-toggle="modal" data-bs-target="#catatanKaprodiModal{{ $pendaftaran->id }}">
                        ...
                        <div class="modal fade" id="catatanKaprodiModal{{ $pendaftaran->id }}" tabindex="-1" aria-labelledby="catatanKaprodiModalLabel{{ $pendaftaran->id }}" aria-hidden="true">
                                    ...
                                    <form action="{{ route('kaprodi.tabel_mbkm.update_catatan', $pendaftaran->id) }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="catatan_kaprodi" class="form-control" id="catatan_kaprodi{{ $pendaftaran->id }}" rows="3" required>{{ old('catatan_kaprodi', $pendaftaran->catatan_kaprodi) }}</textarea>
                                            </div>
                                        </div>
