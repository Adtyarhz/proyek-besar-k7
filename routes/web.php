...
Route::middleware(['auth'])->group(function () {
    ...
    // Doswal KP routes (Table Eligible KP for Doswal)
    ...
    // Kaprodi KP routes (Table Eligible KP for Kaprodi)
    ...
    // Koordinator KP routes (Table Eligible KP for Koordinator)
